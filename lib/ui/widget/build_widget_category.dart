...
import 'package:flutter_moviedbapp/bloc/genre/genre_bloc.dart';
import 'package:flutter_moviedbapp/bloc/genre/genre_bloc_event.dart';
import 'package:flutter_moviedbapp/bloc/genre/genre_bloc_state.dart';
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Column(
                      ...
                      children: <Widget>[
                        GestureDetector(
                          onTap: () {
                            MovieDetailScreen.navigateToDetailScreen(context, movie);
                          },
                          child: ClipRRect(
