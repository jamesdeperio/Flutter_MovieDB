...
import 'package:flutter_moviedbapp/bloc/moviedetail/movie_detail_bloc.dart';
import 'package:flutter_moviedbapp/bloc/moviedetail/movie_detail_bloc_event.dart';
import 'package:flutter_moviedbapp/bloc/moviedetail/movie_detail_bloc_state.dart';
...
class MovieDetailScreen extends StatelessWidget {
  static String routeName = "/MovieDetailScreen";
  static void navigateToDetailScreen(BuildContext context, Movie movie) {
          ...
          body:  BlocBuilder<MovieDetailBloc, MovieDetailState>(
            builder: (context, state) {
              if (state is MovieDetailLoading) {
                ...
                return _buildDetailBody(context,movieDetail);
              } else {
                return Container();
              }
            },
  ...
  Widget _buildDetailBody(BuildContext context, MovieDetail movieDetail) {
    return
            ...
            ClipPath(
              child: ClipRRect(
                child: CachedNetworkImage(
                  ...
                  fit: BoxFit.cover,
                  placeholder: (context, url) => BuildWidgetLoadingIndicator(),
